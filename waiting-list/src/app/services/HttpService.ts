...
export class HttpService {
    ...
    public get(url: string, headersIn?: any): Observable<object> {
        return this.http.get(url, { headers: headersIn, observe: 'response' }).pipe(catchError(error => this.handleError(error)));
    }
    ...
    public post(url: string, body?: any, headersIn?: any): Observable<object> {
        ...
        return this.http.post(url, body, { headers: headersIn, observe: 'response' }).pipe(catchError(error => this.handleError(error)));
    }
    ...
    handleError(error: HttpErrorResponse) {
        ...
        } else if (error.status === HttpConstants.INTERNAL_SERVER_ERROR || error.status === HttpConstants.SERVICE_UNAVAILABLE) {
